...
function App() {
  ...
  return <main>
    <header><a className="brand" href="/" aria-label="KRONOS">KRONOS</a><div className="header-actions"><a href={`https://wa.me/58${whatsapp.slice(1)}`} target="_blank" rel="noreferrer">WhatsApp</a><button className="cart-button" onClick={checkout} disabled={!cart.length}>Carrito ({cart.length})</button></div></header>
